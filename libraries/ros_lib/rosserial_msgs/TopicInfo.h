...
namespace rosserial_msgs
{
  ...
  class TopicInfo : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (this->drop >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->drop >> (8 * 1)) & 0xFF;
      offset += sizeof(this->drop);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->address);
      this->drop =  ((uint16_t) (*(inbuffer + offset)));
      this->drop |= ((uint16_t) (*(inbuffer + offset + 1))) << (8 * 1);
      offset += sizeof(this->drop);
     return offset;
    }

    const char * getType(){ return "rosserial_msgs/TopicInfo"; };
    const char * getMD5(){ return "ad3153fa19f1b3dc15d0e9d3a275d978"; };
