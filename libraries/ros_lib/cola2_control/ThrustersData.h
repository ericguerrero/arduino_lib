#ifndef _ROS_cola2_control_ThrustersData_h
#define _ROS_cola2_control_ThrustersData_h
...
namespace cola2_control
{
  ...
  class ThrustersData : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "cola2_control/ThrustersData"; };
