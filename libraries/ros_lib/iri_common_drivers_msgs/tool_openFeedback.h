#ifndef _ROS_iri_common_drivers_msgs_tool_openFeedback_h
#define _ROS_iri_common_drivers_msgs_tool_openFeedback_h
...
namespace iri_common_drivers_msgs
{
  ...
  class tool_openFeedback : public ros::Msg
  {
    public:
      float angle;
      float effort;
    ...
    const char * getType(){ return "iri_common_drivers_msgs/tool_openFeedback"; };
