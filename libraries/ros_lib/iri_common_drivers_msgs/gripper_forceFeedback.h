#ifndef _ROS_iri_common_drivers_msgs_gripper_forceFeedback_h
#define _ROS_iri_common_drivers_msgs_gripper_forceFeedback_h
...
namespace iri_common_drivers_msgs
{
  ...
  class gripper_forceFeedback : public ros::Msg
  {
    public:
      float current_position;

    gripper_forceFeedback():
      current_position(0)
    {
    }
    ...
    const char * getType(){ return "iri_common_drivers_msgs/gripper_forceFeedback"; };
