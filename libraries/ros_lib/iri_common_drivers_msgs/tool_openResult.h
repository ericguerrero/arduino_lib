#ifndef _ROS_iri_common_drivers_msgs_tool_openResult_h
#define _ROS_iri_common_drivers_msgs_tool_openResult_h
...
namespace iri_common_drivers_msgs
{
  ...
  class tool_openResult : public ros::Msg
  {
    public:
      bool successful;
    ...
    const char * getType(){ return "iri_common_drivers_msgs/tool_openResult"; };
